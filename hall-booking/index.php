				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>We plan everything for your wedding, We manage and decorate the wedding area according to requirement to show a nice wedding.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>Expert are there for your wedding, Expert can design everything what ever you want for your decoration and manage everything.</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
